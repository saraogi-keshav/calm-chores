...
export default function TaskInfoScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-100 dark:bg-gray-900">
      <View className="flex-1 pb-[130px]">
      ...
      <View className="absolute bottom-10 left-0 right-0 h-[130px] bg-gray-100 dark:bg-gray-900 px-4 pt-4 pb-6 shadow-lg border-t border-gray-200 dark:border-gray-800">
        <TouchableOpacity
          onPress={handleUpdateTask}
          disabled={loading}
          className="w-full bg-blue-500 rounded-md p-4 mb-2"
        >
